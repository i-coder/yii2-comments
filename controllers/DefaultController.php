...
//                Yii::$app->session->setFlash('success', Yii::t('yii2mod.comments', 'Комментарий отправлен на модерацию.'));
                return ['status' => 'success',
                    'message' => Yii::t('yii2mod.comments', 'Ваш комментарий отправлен на модерацию.')
                ];
            } else {
                return [
                    'status' => 'error',
